...
public class InviteHistoryAdapter extends ArrayAdapter<InviteHistory> {
    private int resourceId;
    public InviteHistoryAdapter(Context context, int textViewResouceId, List<InviteHistory> objects){
        super(context,textViewResouceId,objects);
        resourceId=textViewResouceId;
    }
    @Override
    public View getView(int position, View convertView, ViewGroup parent){
        InviteHistory friend=getItem(position);
